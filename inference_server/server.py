# src/inference_server/server.py
...
# Add the parent directory of inference_server to sys.path
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "..")))


# 导入环境封装类
from src.envs.simcity_wrapper import SimCityWrapper
...
# 加载训练好的 agent 模型参数
model_save_path = os.path.join("src", "inference_server", "saved_models", "maa2c")
